<template>
	<nav class="f-nav">
		...
		<div class="f-position-right iconfont icon-jiantouxia" @touchstart="handClickBottom"></div>
...
<script>
	import IScroll from "../../../unitl/iscroll/iscroll-probe.js"
